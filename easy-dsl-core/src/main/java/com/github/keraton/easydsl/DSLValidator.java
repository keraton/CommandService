...
public class DSLValidator {
    ...
    private Log LOG = LogFactory.getLog(DSLValidator.class);
    ...
    private boolean contextIsNotLastPlace(Method method) {
        for (int index=0; index < method.getParameterTypes().length; index++) {
            ...
            if ((DSLContext.class.equals(c) || containsContextAnnotation(ann))
    ...
    public boolean isValid(DSL annotation) {
